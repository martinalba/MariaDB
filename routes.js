...
function http(){
    this.configurar = function (app){
        ...
        app.get('/contenido/:id/', function(solicitud, respuesta){
            db.seleccionarIdsenal(solicitud.params.id, respuesta);
        })

        app.get('/detalles/:id/', function(solicitud, respuesta){
            db.seleccionardetalles(solicitud.params.id, respuesta);
        })
